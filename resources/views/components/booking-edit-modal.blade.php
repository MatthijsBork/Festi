                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <form method="post" action="{{ $action }}">
                                ...
                                <div class="mb-4">
                                    <x-input-label for="name">Artiest</x-input-label>
                                    <select id="artist" name="artist"
                                        class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300" disabled>
                                        <option value="{{ $booking->user->id }}">{{ $booking->user->name }}</option>
                                    </select>
                                    @error('artist')
